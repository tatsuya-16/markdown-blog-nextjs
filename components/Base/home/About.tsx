...
const About = () => {
  return (
    <section id="about" className="w-full py-8 md:py-24 lg:py-16 bg-gradient-to-b from-white to-gray-50">
          ...
          <div className="w-full md:w-3/5 space-y-8">
            ...
            <div className="space-y-6 bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-300">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                ...
                Currently working as an intern in software development at UNAIIT Inc.
              </p>
            </div>
            ...
            <div className="space-y-6 bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-300">
              ...
              <div className="flex flex-col space-y-4">
                <div className="flex flex-col md:flex-row md:items-center">
                  <span className="font-bold text-indigo-600 w-32 mb-1 md:mb-0">2025 - present</span>
                  <span className="text-lg text-gray-700 px-4 py-2 bg-gray-50 rounded-lg flex-1">
                    Work at UNAIIT Inc. (Internship)
                  </span>
                </div>
                <div className="flex flex-col md:flex-row md:items-center">
                  <span className="font-bold text-indigo-600 w-32 mb-1 md:mb-0">2024 - present</span>
                  <span className="text-lg text-gray-700 px-4 py-2 bg-gray-50 rounded-lg flex-1">
                    Graduate School of Science and Technology, Meijo University
                  </span>
                </div>
                <div className="flex flex-col md:flex-row md:items-center">
                  <span className="font-bold text-indigo-600 w-32 mb-1 md:mb-0">2020 - 2024</span>
                  <span className="text-lg text-gray-700 px-4 py-2 bg-gray-50 rounded-lg flex-1">
            ...
            <div className="space-y-6 bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg text-center hover:bg-indigo-50 transition-colors duration-300">
                  ...
                  <div className="mt-2 font-medium text-indigo-600">Intermediate</div>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg text-center hover:bg-indigo-50 transition-colors duration-300">
                  <h3 className="text-xl font-bold text-gray-800">Spanish</h3>
                  <div className="mt-2 font-medium text-indigo-600">Beginner</div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <Link href="mailto:ta16tech@gmail.com" className="flex items-center justify-center gap-2 bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 flex-1 text-center">
                <Mail size={20} className="text-gray-700" />
                <span className="text-lg font-medium">ta16tech@gmail.com</span>
              </Link>
              <Link href="https://github.com/tatsuya-16" className="flex items-center justify-center gap-2 bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 flex-1 text-center">
                <Github size={20} className="text-gray-700" />
                <span className="text-lg font-medium">tatsuya-16</span>
              </Link>
              <Link href="https://www.linkedin.com/in/tatsuya-abe-1b1b94354/" className="flex items-center justify-center gap-2 bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 flex-1 text-center">
